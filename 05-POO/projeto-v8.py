...
class CaixaRegistradora:
    ...
    def adicionar_produto(self, produto):
        ...
        if(isinstance(produto, Produto)):
            # Att as quantidades de estoque e de escolha do produto
...
loja_do_joao.adicionar_produto(calculadora)
loja_do_joao.adicionar_produto(calculadora)
for produto in loja_do_joao.carrinho:
    print(produto)

# Mas, se eu quiser add produtos em grandes quantidades ao invés de 1 a 1?
