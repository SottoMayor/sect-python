...
caderno = Produto('Caderno do Max Steel', 23.75, 34)
caneta = Produto('Caneta BIC', 1, 10000)

loja_do_joao = CaixaRegistradora('Loja do João')

# Adicionando vários produtos de uma vez no carrinho
loja_do_joao.adicionar_produto(calculadora, 1)
loja_do_joao.adicionar_produto(caderno, 2)
loja_do_joao.adicionar_produto(caneta, 10)

# Posso chamar o método ver_carrinho aqui
loja_do_joao.ver_carrinho()

print('\n' + 30*'#-' + '\n')  # Demarcador

# Além disso, posso pedir para fechar a conta
