...
'''
    ...
    Passos:
        1 - Definindo métodos
        2 - Definindo atributos e herança
        3 - Construindo métodos mudar_cobertura e mudar_recheio
        4 - Método mágico __str__
        5 - Integrando a Boleria com o Caixa Registradora
        --- FIM ---
'''
...
class Boleria(Produto):
    ...
    def __init__(
        ...
        # Herdando atributos... e passando novos atributos.
    ...
    def mudar_cobertura(self, nova_cobertura):
        # Atrubuindo a nova cobertura como sendo a cobertura do bolo
        self.cobertura = nova_cobertura

    # Método para mudar o recheio do bolo
    def mudar_recheio(self, novo_recheio):
        # Atrubuindo o novo recheio como sendo a cobertura do bolo
...
# Instanciando Boleria e usando método mudar_recheio
...
# Instanciando Caixa Registradora, apenas com bolos pedidos pela dona Ana
...
# Instanciando Caixa Registradora, apenas com bolos pedidos pelo Agostinho
# Carrara
