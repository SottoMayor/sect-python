...
# OBS: Observe que o print da instância bolo de cenoura é do mesmo modelo da
# estrutura Produto, já que a Boleria está herdando métodos de Produto.

# Vamos criar um print personalizado para as instâncias de Boleria
