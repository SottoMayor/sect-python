...
# Graças ao método __iter__ podemos omitir o .carrinho na hora de iterar
for produto in loja_do_joao:
    print(produto)

# Procurando produto pelo ID
# loja_do_joao.procurar_produto_por_id(10) # É preciso dar print!
print(loja_do_joao.procurar_produto_por_id(10))  # calculadora
print(loja_do_joao.procurar_produto_por_id(99999999))  # Não existe!
